...
public class PageNavigation {
	...
	public void makeNavigator() {
		...
		buffer.append("				<a href=\"javascript:pageMove(1);\" class=\"page-link\"><<</a> \n");
		buffer.append("			</li> \n");
		buffer.append("			<li class=\"page-item\"> \n");
		buffer.append("				<a href=\"javascript:pageMove(" + (this.startRange ? 1 : (startPage - 1)) + ");\" class=\"page-link\"><</a> \n");
		buffer.append("			</li> \n");
		...
		buffer.append("			<li class=\"page-item\"> \n");
		buffer.append("				<a href=\"javascript:pageMove(" + (this.endRange ? endPage : (endPage + 1)) + ");\" class=\"page-link\">></a> \n");
		buffer.append("			</li> \n");
		buffer.append("			<li class=\"page-item\"> \n");
		buffer.append("				<a href=\"javascript:pageMove(" +  + totalPageCount + ");\" class=\"page-link\">>></a> \n");
		buffer.append("			</li> \n");
		buffer.append("		</ul> \n");
