...
<!--                   <input type="hidden" name="action" id="action" value="searchMember"> -->
                       ...
                       <input type="search" class="form-control" placeholder="검색어 입력" name="searchWord" id="searchWord">
                ...
                <table class="table table-striped table-bordered table-hover">
                  ...
                  <tr>
                     ...
                     <input type="hidden" value="${m.userid }" id="user">
                     <button type="submit" onclick="deleUser();" deleteBtn" class="btn btn-secondary">회원 탈퇴</button>
...
<script type="text/javascript">
   function deleUser(){
    	var user = $("#user").val();
    	if (confirm("정말 탈퇴 시키겠습니까?") == true){//확인 
    		alert("탈퇴가 완료되었습니다."); 
    		 location.href="${root}/member/deleteMemberById?userid="+user;
    	}else{//취소
    		return; 
    	}
   ...
   function pageMove(pg) { 
       ...
       document.getElementById("pageform").action = "${root}/member/memberInfo";
