	...
	<section id="contact" class="contact">
		<div class="container">
			...
			<div align=right class="mb-3">
				<form action="<c:url value='/fav/favoriteList' />" method="get" id="searchForm">
			...
			<table class="table table-striped table-bordered table-hover">
				...
				<c:forEach var="n" items="${favoriteH }" varStatus="vs">
					<tr>
						<td style="text-align:center;">${n.dong }</td>
						<td style="text-align:center;"><a href='${root}/map/detailHouse?no=${n.no}'>${n.aptName }</a></td>
...
//     	  $('#searchKey option[value=${searchKey}]').prop('selected', 'selected').change();
         $("#searchBtn").click(function(){
           ...
           if ($("#searchWord").val() == "" && $("#searchKey").val() == "all" ) {
             location.href="${root}/fav/favoriteList";
          }
            $("#searchForm").submit();
...
// 		});
      function pageMove(pg) { 
         ...
         document.getElementById("pageform").action = "${root}/fav/favoriteList";
